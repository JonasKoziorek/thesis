...
\begin{figure}[!h]
    ...
    \caption{
        ...
        Both cases (a) and (b) show a trajectory $T_{50}^{100}(\mathcal{L}_{r}, 0.5)$ (left) and a projection of the trajectory onto a single line (right). 
...
\begin{figure}[!h]
    ...
    \caption{
        ...
        Red region: region of stability.
        Red point (a): attracting fixed point.
        Blue region: region of instability.
        Blue point (b): repelling fixed point.
        }
    }
...
\begin{theorem}
    Let $\left(\mathbb{R}, \mathcal{L}_r\right)$ be a DDS. Then there exists at most one stable periodic orbit for each $r$.~\cite[p.~74]{Devaney20211026}
\end{theorem}
...
\begin{figure}[!h]
    ...
    \caption{
        \textcolor{darkred}{
        Cobweb diagrams of a trajectory $T_{50}^{100}(\mathcal{L}_{r}, 0.5)$ and a projection of the trajectory onto a line. 
...
\begin{figure}[!h]
    ...
    \caption{
        ...
        Trajectories $T_{4500}^{5000}(\mathcal{L}_{r}, x_0)$ are plotted.
        }
    }
