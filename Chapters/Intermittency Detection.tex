...
\begin{figure}[!h]
    ...
    \caption{
        ...
        The bifurcation diagram of the Logistic map $\mathbb{L}_{r}$ for $r \in \langle 3.825, 3.83 \rangle$ is displayed.
        The bifurcation diagram consists of projections of $T_{900}^{1000}(\mathbb{L}_{r}, 0.5)$.
...
The next step is to find parameters $p_L$ and $p_U$ such that parameters $p$ between $p_L$ and $p_U$ have $l_{avg}$ from range $\langle L, U \rangle$.
}
\par
\textcolor{red}{
...
A color range is defined for numbers in range $\langle l_{avg}$ for $p_L, l_{avg}$ for $p_U \rangle$.
The trajectory projections for parameters $p \in \langle p_L, p_U \rangle$ are colored using this color range.
...
\begin{figure}[!h]
    ...
    \caption{
        ...
        The bifurcation diagram of the Logistic map $\mathbb{L}_{r}$ for $r \in \langle 3.6263, 3.6267 \rangle$ is displayed.
        The bifurcation diagram consists of projections of $T_{900}^{1000}(\mathbb{L}_{r}, 0.5)$.
...
\begin{figure}[!h]
    ...
    \caption{
        ...
        The bifurcation diagram of the Logistic map $\mathbb{L}_{r}$ for $r \in \langle 3.62, 3.65 \rangle$ is displayed.
        The bifurcation diagram consists of projections of $T_{900}^{1000}(\mathbb{L}_{r}, 0.5)$.
