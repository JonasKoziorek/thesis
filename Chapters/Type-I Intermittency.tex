...
\begin{figure}[!h]
    ...
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{DDS/Figures/pre_reinjection_points_example{1}.png}
        \caption{}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{DDS/Figures/pre_reinjection_points_example{2}.png}
        \caption{}
    \end{subfigure}

    \caption{
        \textcolor{red}{ 
        An illustration of pre-reinjection points and laminar interval.
        Both (a) and (b) $\mathbb{L}_{r}(x+x^{*})-x^{*}$, that is the Logistic map $\mathbb{L}_{r}^{3}$ for $r = 3.827$ that is shifted so that $x^{*} \approxeq 0.5143552770619905$ is in the center $(0,0)$. 
        (a) provides the full graph. 
        (b) shows a close-up to a region of interest. 
        The red dots are the pre-reinjection points.
        The blue dots are point reinjected into the laminar interval.
        Laminar interval $I_l = \langle x^{*}-c, x^{*}+c \rangle$ for $c = 0.03$.
        $I_l$ shown in as orange line.
        $x^{*}$ is shown as a green dot.
        }
    }
...
By using the Eq.~\ref{eq:int_I_local_map} the difference between two successive points $x_n - x_{n-1} \approx dx/dl$ can be written as:
\begin{equation}
...
\begin{figure}[!h]
    ...
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{DDS/Figures/characteristic_relation_fit{1}.png}
        \caption{}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{DDS/Figures/characteristic_relation_fit{2}.png}
        \caption{}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{DDS/Figures/characteristic_relation_fit{3}.png}
        \caption{}
    \end{subfigure}
    ...
    \caption{
        ...
        Third iterate of the Logistic map $\mathbb{L}_{r}^{3}$ was used.
        $r^{*} = 1 + \sqrt{8}$ is the saddle-node bifurcation parameter.
        The three corresponding fixed points are $x^{*}_{1} = 0.1599$, $x^{*}_{2} = 0.5143$ and $x^{*}_{3} = 0.9563$.
        Average laminar length $l_{avg}$ was measured for $N = 4000$ reinjected points.
        Laminar lengths were obtained using Eq.~\ref{eq:laminar_length}. 
        Parameter $c$ is fixed as $0.01, 0.03, 0.05$ or $0.07$.
        $30$ parameters $r$ were randomly chosen from interval $\langle r^{*}-10^{-5}, r^{*}-10^{-13} \rangle$.
...
\begin{figure}[!h] \ContinuedFloat
    ...
    \caption{
        ...
        The bifurcation diagrams are constructed for the Pomeau-Manneville map $f_{\varepsilon} = (1+\varepsilon)x+(1-\varepsilon)x^2 \pmod{1}$. 
