...
Forward orbit in figure \ref{fig:intermittent_forward_orbit_example} exhibits type I intermittency which is related to \hyperref[def:saddle_node_bif]{saddle-node bifurcation} or it's inverse.
