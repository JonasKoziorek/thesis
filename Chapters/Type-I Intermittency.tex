...
\begin{figure}[!h]
    ...
    \caption{
        \textcolor{darkred}{ 
        Pre-reinjection points and laminar interval of $\mathbb{L}_{r}^{3}(x+x^{*})-x^{*}$ for $r = 3.827$ and $x^{*} \approxeq 0.51435$.
        (a) the full graph. 
...
\begin{figure}[!h]
    ...
    \caption{
        ...
        % The fixed points of $\mathbb{L}_{r^{*}}^{3}$ are $x^{*}_{1} = 0.1599$, $x^{*}_{2} = 0.5143$ and $x^{*}_{3} = 0.9563$.
...
\begin{figure}[!h]
    ...
    \caption{
        ...
        (a) $T_{12000}^{25000}(\mathcal{P}_{\varepsilon}, x_0)$
        (b) $T_{13900}^{25000}(\mathcal{P}_{\varepsilon}, x_0)$ 
        (c) $T_{20000}^{25000}(\mathcal{P}_{\varepsilon}, x_0)$ 
        (d) $T_{24000}^{25000}(\mathcal{P}_{\varepsilon}, x_0)$.
        Initial condition: $x_0 = 0.5$.
