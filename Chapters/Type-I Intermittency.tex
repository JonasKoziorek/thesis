...
\textcolor{darkred}{
This Chapter is concerned with the phenomena of intermittency, especially type-I intermittency.
Firstly discovery and history of intermittency is mentioned.
Then intermittency is motivated mathematically.
Furthermore, the idea of laminar length and charasteristic relation is introduces.
Lastly, the ambiguity of bifurcation diagram caused by intermittency is shown.
}

\section{History}
Intermittency is one type of a transition between chaos and periodicity.
...
Subsequently, Pomeau and Manneville found analogous behavior in the Lorenz system~\cite{Lorenz2004}.
Through a numerical analysis of this system, they introduced the concept of intermittency and classified it into three categories.~\cite{Pomeau1980}
\par
...
For better understanding of intermittency, modern theory has been developed~\cite{Elaskar2017}.
