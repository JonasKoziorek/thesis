...
begin
    ...
    # upper left timeseries
    total_n = 500
    p = [4.45]
    upper1_1_color = BLUE
    ax3 = DDS.timeseries!(upper_grid[1,1], pomeau_manneville, x0, p, total_n, 1; 
        ax_aspect=2, 
        markersize=POINT_SIZE,
        xtick_period=100,
        linewidth=LINEWIDTH+0.3, 
        dot_color=upper1_1_color,
        title="Evolution for ϵ=$(p[1]), x0=$(x0)"
    )
    ...
    # upper right timeseries
    total_n = 500
    p = [4.56]
    upper1_3_color = ORANGE
    ax4 = DDS.timeseries!(upper_grid[1,3], pomeau_manneville, x0, p, total_n, 1; 
        ax_aspect=2, 
        markersize=POINT_SIZE, 
        xtick_period=100,
        linewidth=LINEWIDTH+0.3, 
    ...
    # intermitten timeseries
    total_n = 8500
    p = [4.47458]
    lower1_1_color = GREEN
    ax5 = DDS.timeseries!(lower_grid2[1,1], pomeau_manneville, x0, p, total_n, 1; 
        ax_aspect=4,
        markersize=POINT_SIZE, 
        xtick_period=500, 
        linewidth=LINEWIDTH, 
