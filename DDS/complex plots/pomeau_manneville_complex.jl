...
begin
    ...
    p = [4.45]
    upper1_1_color = BLUE
    ax3 = DDS.forward_orbit!(upper_grid[1,1], pomeau_manneville, x0, p, total_n, 1; 
        ax_aspect=2, 
        markersize=POINT_SIZE,
        xtick_period=100,
        linewidth=LINEWIDTH+0.3, 
        dot_color=upper1_1_color,
        title="Forward orbit for ϵ=$(p[1]), x0=$(x0)"
    )
    ...
    ax4 = DDS.forward_orbit!(upper_grid[1,3], pomeau_manneville, x0, p, total_n, 1; 
        ax_aspect=2, 
        markersize=POINT_SIZE, 
        xtick_period=100,
        linewidth=LINEWIDTH+0.3, 
    ...
    ax5 = DDS.forward_orbit!(lower_grid2[1,1], pomeau_manneville, x0, p, total_n, 1; 
        ax_aspect=4,
        markersize=POINT_SIZE, 
        xtick_period=500, 
        linewidth=LINEWIDTH, 
