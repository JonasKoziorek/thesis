...
begin
    ...
    p = [1.185, 0.3]
    upper1_1_color = BLUE
    ax3 = DDS.timeseries!(upper_grid[1,1], henon, x0, p, total_n, 1; 
        ax_aspect=2, 
    ...
    ax4 = DDS.timeseries!(upper_grid[1,3], henon, x0, p, total_n, 1; 
        ax_aspect=2, 
        markersize=POINT_SIZE, 
        xtick_period=100,
        linewidth=LINEWIDTH+0.3, 
    ...
    ax5 = DDS.timeseries!(lower_grid2[1,1], henon, x0, p, total_n, 1; 
        ax_aspect=4,
        markersize=POINT_SIZE, 
        xtick_period=500, 
        linewidth=LINEWIDTH,
