...
begin
    ...
    p = [3.82]
    upper1_1_color = BLUE
    ax3 = DDS.timeseries!(upper_grid[1,1], logistic, x0, p, total_n, 1; 
        ax_aspect=2, 
        markersize=POINT_SIZE,
        xtick_period=100,
        linewidth=LINEWIDTH+0.3, 
        dot_color=upper1_1_color,
        title="Evolution for r=$(p[1]), x0=$(x0)"
    )
    ...
    ax4 = DDS.timeseries!(upper_grid[1,3], logistic, x0, p, total_n, 1; 
        ax_aspect=2, 
        markersize=POINT_SIZE, 
        xtick_period=100,
        linewidth=LINEWIDTH+0.3, 
    ...
    ax5 = DDS.timeseries!(lower_grid2[1,1], logistic, x0, p, total_n, 1; 
        ax_aspect=4,
        markersize=POINT_SIZE, 
        xtick_period=500, 
        linewidth=LINEWIDTH,
