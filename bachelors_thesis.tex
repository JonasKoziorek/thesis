...
\CzechAbstract{
    ...
    Text se zaměřuje na intermitenci typu I, která je spojena se sedlovou bifurkací.
    Nejprve je představena teorie diskrétních dynamických systémů a intermitence typu I.
    Dále je vedena diskuze o významu detekce intermitence typu I.
    ...
    Nakonec je vedena diskuze o implementaci v programovacím jazyce Julia.
    }
    }
...
\EnglishAbstract{
    ...
    The focus of the text is on the type-I intermittency which is associated with saddle-node bifurcations.
    Firstly, the theory of discrete dynamical systems and of type-I intermittency is introduced.
    Furthermore, the importance of detection of type-I intermittency is discussed.
    By combining several algorithms of other authors, the detection is achieved for the Logistic map.
    The results of the detection is presented graphically through colorization of a bifurcation diagram.
    Lastly the implementation in Julia programming language is discussed.
    }
    }
